...
const Newsletter = () => {
  return (
    ...
    <div className='flex items-center justify-center w-full h-[462px] relative'>
        <img src='/images/bgimg.jpg' className='w-full h-[400px] object-cover' alt='background'/>
      <div className='absolute flex flex-col items-center justify-center gap-8 w-[550px]'>
        ...
        <button className='bg-[#FB2E86] rounded-[2px] text-white text-[14px] py-2 w-[100px]'>Shop Now</button>
        </div>
    </div>
